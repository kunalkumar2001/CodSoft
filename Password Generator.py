...
lengthLabel=Label(root,text=' Enter User Name :',font=Font,bg='gray20',fg='white')
...
copyButton=Button(root,text='Copy',font=Font,command=copy,bg="red",fg="white")
copyButton.grid(row=8,column=1,pady=5)
